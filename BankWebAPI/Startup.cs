...
namespace BankWebAPI
{
    public class Startup
    {
        ...
        {
            services.AddScoped(typeof(EurofinsDBContext));
            services.AddControllers();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BankWebAPI", Version = "v1" });
            });
            services.AddScoped<IAccountservice<BankAccount>, Accountservices>();
            services.AddScoped<IAccountRepo<BankAccount>, AccountRepo>();
